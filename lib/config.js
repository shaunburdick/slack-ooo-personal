...
function parse (config) {
  ...
  config.app.respond.channelPersonal = parseBool(process.env.APP_RESPOND_CHANNEL_PERSONAL) || config.app.respond.channelPersonal;
  ...
  config.app.mirrorPings = parseBool(process.env.APP_MIRROR_PINGS) || config.app.mirrorPings;
  config.app.stealthMode = parseBool(process.env.APP_STEALTH_MODE) || config.app.stealthMode;
