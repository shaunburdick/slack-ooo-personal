...
function parse (config) {
  ...
  config.app.response.dmprefix = process.env.APP_DMPREFIX || config.app.response.dmprefix;
  config.app.response.channelprefix = process.env.APP_CHANNELPREFIX || config.app.response.channelprefix;
