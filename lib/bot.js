...
class Bot {
  ...
  announceConfig () {
    const message = {
      ...
      attachments: [{
        ...
        fields: [
          {
            title: 'Start Time',
            value: this.config.app.timebox.start ? new Date(this.config.app.timebox.start) : 'now',
            short: true
          },
          {
            title: 'End Time',
            value: this.config.app.timebox.end ? new Date(this.config.app.timebox.end) : 'never',
            short: true
          },
          {
            title: 'Message',
    ...
    if (this.config.app.respond.keywords.length) {
      message.attachments.fields.join({
